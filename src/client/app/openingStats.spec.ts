...
it('error never exposes stale totals or menu retry; diagnostics remain available', () => {
 const nodes = {root:{classList:{toggle:vi.fn()}},label:{hidden:true,textContent:'',dataset:{}},retry:{hidden:false,disabled:false},white:{textContent:'19'},black:{textContent:'21'}};
