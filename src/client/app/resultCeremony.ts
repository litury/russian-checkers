...
import rearUrl from './result-art/rear.webp?url';
import lipUrl from './result-art/lip.webp?url';
import gripLeftUrl from './result-art/grip-left.webp?url';
import gripRightUrl from './result-art/grip-right.webp?url';
import pedestalUrl from './result-art/pedestal.webp?url';
import mantle0 from './result-art/mantle-0.webp?url';
import mantle1 from './result-art/mantle-1.webp?url';
import mantle2 from './result-art/mantle-2.webp?url';
import lidUrl from './result-art/lid.webp?url';
